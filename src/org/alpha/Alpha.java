...
import org.alpha.model.EasyEventLog;
import org.alpha.model.PetriNet;
import org.alpha.model.Place;
import org.alpha.model.Trace;
...
public class Alpha {
    ...
    public PetriNet getPetriNet() {
        ...
        EasyEventLog eventLog = parse(xesFile);
        if (eventLog == null) {
            return null;
        }
    ...
    private EasyEventLog parse(File xesFile) {
